...
$securePass   = Get-Content "C:\Share_Details\sqlpass.txt" | ConvertTo-SecureString

$cred = New-Object System.Management.Automation.PSCredential("monitor", $securePass)
$password = $cred.GetNetworkCredential().Password

$servers = Get-Content $serversList
$jobs = @()

$connectionString = "Data Source=$dbServer;Database=$databaseName;User ID=$($cred.UserName);Password=$password;TrustServerCertificate=True;"
